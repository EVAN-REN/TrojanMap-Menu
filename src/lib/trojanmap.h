...
class TrojanMap {
 public:
  ...
  bool hasCycle_DFS(std::vector<std::string> &subgraph, std::unordered_map<std::string, bool> allsubgraph, std::string cNodeId, std::string pNodeId, std::vector<double> &square);
