...
public:
  ...
  int ScrollLongWarningText(std::string s, int intervalMilliSeconds = 10, int y = 0)
  {
    ...
    std::string token;
    int count = y;
    attron(COLOR_PAIR(5)); // Change color
    while ((pos = s.find(delimiter)) != std::string::npos)
    {
      token = s.substr(0, pos);
      ScrollText(token, /*intervalMilliSeconds=*/1, /*y=*/count);
  ...
  int ScrollLongErrorText(std::string s, int intervalMilliSeconds = 10, int y = 0)
  {
  ...
  int ScrollLongMenuText(std::string s, int intervalMilliSeconds = 10, int y = 0)
  {
  ...
  int ScrollLongResultText(std::string s, int intervalMilliSeconds = 10, int y = 0)
  {
    ...
    std::string token;
    int count = y;
    attron(COLOR_PAIR(4)); // Change color
    while ((pos = s.find(delimiter)) != std::string::npos)
    {
      token = s.substr(0, pos);
      ScrollText(token, /*intervalMilliSeconds=*/1, /*y=*/count);
